...
Figures/              Publication figure-reproduction bundles
```

## Citation

If `dirac_wavepacket` contributes to a publication, please cite the associated
*Computer Physics Communications* paper (in preparation) and this
repository. A `CITATION.cff` file is provided once the paper DOI is
assigned.
